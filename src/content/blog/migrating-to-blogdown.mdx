...
tags:
  ...
  - web
  - Blogdown
headerImage: "/images/hugoCover.jpg"
draft: false
---
...
Last year, I heard about *static site generators*. The proposition of a static site is to shift the heavy load from the moment visitors request the content to the moment content actually changes i.e. when the website content is being updated by the website owner. Some of the key advantages are:
...
Blogdown is an R package which is designed to simplify the building of websites directly from R Markdown documents. As described by the package author:
...
{/* TODO: DiagrammeR flowchart showing the blogdown workflow (RMarkdown -> Hugo -> GitHub -> Netlify) was rendered as an interactive widget. The original used grViz to create this diagram. */}
...
{/* TODO: Leaflet interactive map widget was rendered here showing a marker at Southampton University */}
...
{/* TODO: Interactive plotly bar chart of diamonds dataset was rendered here */}
