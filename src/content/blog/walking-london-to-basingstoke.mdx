...
The route we followed prioritised directness over scenic beauty. The map below shows the route we followed, and it is almost a direct straight bearing between London and Basingstoke. This was great for efficiency, but as explained later, some of the roads definitely made it hard to remain motivated.

{/* TODO: Leaflet interactive map showing the walking route from London to Basingstoke */}
