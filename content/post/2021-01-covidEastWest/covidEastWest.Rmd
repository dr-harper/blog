...
```{r Stringency, fig.width = 10, fig.height=10, fig.cap = "Stringency Index provided for each country"}
df_selected %>%
...
To demonstrate this, we can use the stringency index data provided. Figure \@ref(fig:timeTolockdown) shows the number of deaths recorded in each country at the time that they increased their Stringency value to 70 (a value which represents quite a high level of restriction like lockdown), of the 9 countries which were mentioned in the paper above, 6 of them were classified into the "Group 2"
