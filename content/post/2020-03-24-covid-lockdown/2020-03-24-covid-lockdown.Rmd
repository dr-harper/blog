---
title: "The problem with Linear graphs and Covid-19"
type: post
...
```{r deathPlot, fig.height=8, fig.width=8, message = F, warning = F, fig.cap = "Cumulative number of deaths plotted for the key countries frequently used in discussions, compared against dates since outbreaks"}
...
ggplot() +
  ...
  labs(x = "Days Since 10th Death",
       ...
       subtitle = "UK, Spain and Italy have higher levels of deaths than China at this stage of the pandemic",
...
```{r casesPlots, fig.height=8, fig.width=12, fig.cap = "Comparison of countries which have outbreaks with more than 200 recorded cases"}
