---
title: Creating Twitter Wordcloudsin R
author: Mikey Harper
description: A guide on how to make wordclouds using the rtweet package in R.
date: '2018-12-12'
...
```{r wordCloud2, fig.cap = "Wordcloud with our Twitter outline", eval = FALSE}
wordcloud_twitter <- wordcloud2(data = textCorpus[1:500,], figPath = system.file("examples/t.png",package = "wordcloud2"))
wordcloud_twitter
```
