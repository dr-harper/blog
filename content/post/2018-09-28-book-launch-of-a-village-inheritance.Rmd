...
header_image: "https://i.imgur.com/dOAF2NK.jpg"
---
...
```{r}
knitr::include_graphics("https://i.imgur.com/VduMVbl.jpg")
```
...
knitr::include_graphics("https://github.com/dr-harper/blog/blob/master/images/BookOldNew.jpg?raw=true")
```
...
```{r housePlans, fig.cap = "The original house drawings produced in the 1920s (left) and the digitally restored copy (right)."}
knitr::include_graphics("https://github.com/dr-harper/blog/blob/master/images/houseDrawings.jpg?raw=true")
```
