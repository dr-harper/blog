...
I am a data scientist working in the energy sector. It's my mission to help shift our energy reliance from fossil fuels to 100% renewable energy. Reaching such a target will require massive shifts in the way that both technology and people interact with the energy system.

I love working on data science **innovation projects**. Some times they work, many times they fail, but the experience learned is always useful and helps steer the course to a beter solution.
...
I do a limited amount of consulting, but if you have a data science project, feel free to drop me a line and we can discuss.
