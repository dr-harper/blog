...
<span class="label label-primary">Renewable Energy</span>
<span class="label label-primary">Building Physics</span>
<span class="label label-primary">Heat Pumps</span>
<span class="label label-primary">R</span>
<span class="label label-primary">Geospatial Data</span>
...
```{r}
jobTitle <- function(logo = "https://www.businessmagnet.co.uk/manage-account/uploadedLogos/177399.jpg", 
  ...
  # Check if a URL is provided; if so, wrap the company name in an <a> tag
  company_display <- if (!is.null(company_url) && company_url != "") {
    glue::glue('<a href="{company_url}" target="_blank" style="color:#616A6B;">{company}</a>')
  } else {
    company
  }
...
<!-- 5. The Contact Details -->
  ...
  <tr>
    <td colspan="5" style="background-color: #f9f9f9; border:hidden;"><i class="fas fa-business-time" style="color:#616A6B;"></i> {{company_display}}</td>
  </tr>
  <tr>
...
```{r}
jobTitle(logo = "/images/Heat Geek Logo_Colour_Email.png",
         title = "Data & Insights Lead",
         company = "Heat Geek",
         dates = "December 2022 - Present",
         location = "London, UK",
          company_url = "https://heatgeek.com/")
```

- Part of the Founding Team at Heat Geek
- Have developed a data-driven approach to heat pump installations, using machine learning to predict the best heat pump for a property
- Build multiple data APIs to integrate data science across the business platform
...
jobTitle(logo = "/images/OVOLogo.png",
         ...
         location = "London, UK",
          company_url = "https://www.ovoenergy.com/")
```

**Key Achievements:**

- Worked on energy efficiency insights for customers, providing tips and tricks on how people can reduce their energy consumption
- Built predictive models to forecast gas consumption at a customer level
- Engaged with senior stakeholders to steer and influence projects
- Winner of the "Plan Zero Hero" award, recognising my commitment to decarbonisation
...
jobTitle(logo = "/images/FlowminderLogo.png",
         ...
         location = "Southampton, UK",
          company_url = "https://www.flowminder.org/")
```
