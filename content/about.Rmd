...
<!-- 5. The Contact Details -->
  ...
  <tr>
    <td colspan="5" style="background-color: #f9f9f9; border:hidden;"><i class="fas fa-business-time" style="color:#616A6B;"></i> {{dates}}</td>
  </tr>
  <tr>
    <td colspan="5" style="background-color: #f9f9f9; border:hidden;"><i class="fas fa-location" style="color:#616A6B;"></i> {{location}}</td>
  </tr>
  <tr>
</table>', , .open = "{{", .close = "}}")
  )
...
```{r heatingOptimiser, fig.cap = "Much of my work at SSE was spent optmising heating schedules around occuopancy data.", out.width="70%"}
...
- Developed a suite of models including occupancy classification, well-being monitoring and energy saving.
...
- Developed a heating optimisation model which calculates the optimal heating profile for buildings and identifies potential energy wastage due to heating outside of occupied periods. Trial sites demonstrated a 20% reduction in energy demand.
...
- Developed cloud based web apps for geospatial visualisation and analysis, which were used to engage witt non-technical stakeholders.
