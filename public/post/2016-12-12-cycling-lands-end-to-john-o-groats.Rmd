...
Doing it unsupported, we needed to carry everything with us on our bike. It is amazing how quickly space runs out and how heavy your bike can quickly become.  The following list weighed around 6kg, and once you add in a bit food and drink for the days ride it could come to around 10kg extra weight on the bike.
...
![LEJOG Jerseys, designed using Owayo](https://github.com/mikey-harper/TestWebsite/blob/master/_images/LEJOG%20Jersey%20HiRes.jpg?raw=true)
...
We completed our trip from Friday 27th May to Sunday 5th June 2016. This section provides a short explanation for each day of the trip, and by no means is meant to be a comprehensive account. The following graphs summarise the distance and elevation for each day of the trip, and you can view the full data for each day here (opens external link to Strava): Day 1, Day 2, Day 3, Day 4, Day 5, Day 6, Day 7, Day 8
